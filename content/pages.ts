...
export const pageDefinitions: PageDefinition[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "sources",
        body: ["Page and line citations for the Science and Health passages above were not included in the reading script prepared for this meeting. Contact the Reading Room if you would like the exact citations."],
        style: "stone"
      }
    ]
  },

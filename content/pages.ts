...
export const pageDefinitions: PageDefinition[] = [
  ...
  },
  {
    ...
    actions: [{ label: "View Latest Reading", href: "/sermons/a-grateful-heart", variant: "primary" }],
    sections: [
  ...
  {
    path: "/sermons/a-grateful-heart",
    eyebrow: "WEDNESDAY TESTIMONY MEETING · AUGUST 5, 2026",
    title: "A Grateful Heart",
    description: "Bible and Science and Health readings on gratitude, prepared and read by Lauren McFall for the August 5, 2026 Wednesday Testimony Meeting at Christian Science Aurora.",
    actions: [
    ...
    structuredData: {
      ...
      about: "Bible and Science and Health with Key to the Scriptures readings on gratitude",
      contributor: { "@type": "Person", name: "Lauren McFall" },
    ...
    sections: [
      {
        id: "about",
        body: ["These readings on gratitude were prepared and read by Lauren McFall for the Wednesday Testimony Meeting on August 5, 2026, and are shared here in the order they were read."]
      },
      {
        id: "bible-readings",
        ...
        body: [
          ...
          "***Source: 2 Corinthians 9:6–11.***",
          "**Hebrews**",
          "By him therefore let us offer the sacrifice of praise to God continually, that is, the fruit of our lips giving thanks to his name.",
          "But to do good and to communicate forget not: for with such sacrifices God is well pleased.",
          "***Source: Hebrews 13:15–16.***",
          "**First Thessalonians**",
          "Rejoice evermore.",
          "Pray without ceasing.",
          "In every thing give thanks: for this is the will of God in Christ Jesus concerning you.",
          "***Source: First Thessalonians 5:16–18.***"
        ]
      },
      {
        ...
        body: [
          ...
          "***Source: Science and Health with Key to the Scriptures, 3:17–26.***",
          ...
          "***Source: Science and Health, 4:3–9.***",
          "Tithe. Contribution; tenth part; homage; gratitude.",
          "***Source: Science and Health, 595:22.***",
          ...
          "***Source: Science and Health, 15:25–30.***",
          ...
          "***Source: Science and Health, 9:5–16.***",
          ...
          "***Source: Science and Health, 248:3–11.***",
          ...
          "***Source: Science and Health, 258:1–8.***",
          "Divine Love always has met and always will meet every human need. It is not well to imagine that Jesus demonstrated the divine power to heal only for a select number or for a limited period of time, since to all mankind and in every hour, divine Love supplies all good.",
          "***Source: Science and Health, 494:10–14.***",
          "The miracle of grace is no miracle to Love. Jesus demonstrated the inability of corporeality, as well as the infinite ability of Spirit, thus helping erring human sense to flee from its own convictions and seek safety in divine Science.",
          "***Source: Science and Health, 494:15–19.***",
          ...
          "***Source: Science and Health, 518:13–19.***",
          ...
          "***Source: Science and Health, 367:17–23.***",
          "Millions of unprejudiced minds — simple seekers for Truth, weary wanderers, athirst in the desert — are waiting and watching for rest and drink. Give them a cup of cold water in Christ’s name, and never fear the consequences.",
          "***Source: Science and Health, 570:14–18.***",
      ...
      {
        id: "testimonies",
        eyebrow: "TESTIMONIES OF GRATITUDE",
        title: "Republished from the Christian Science Journal and Christian Science Sentinel",
        style: "teal-mist",
        body: [
          ...
          "I owe to our beloved Leader, Mrs. Eddy, gratitude which words cannot express.",
      ...
      {
        id: "sources",
        body: ["Bible citations are King James Version. Science and Health citations refer to Science and Health with Key to the Scriptures, by Mary Baker Eddy."],
        style: "stone"
      }
    ]
  },
